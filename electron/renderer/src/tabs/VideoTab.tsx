...
export default function VideoTab() {
  ...
  // `isHlae`'s section is conditional at render time, so SECTIONS is built
  // inline (spread) rather than a module-level constant -- same behaviour as
  // the `{isHlae && (...)}` block it replaces.
